...
--Album art
local art = helpers.imagebox (
  os.getenv ("HOME") .. "/.config/awesome/assets/control_center/music.svg",
  60,
  60
)
art.halign = "center"
...
--Title
local title_widget =
  helpers.textbox (color.lightblue, user.font .. " bold 15", "Nothing playing")
...
--Artist
local artist_widget =
  helpers.textbox (color.mid_light, user.font .. " 13", "Unknown artist")
...
local play_pause =
  helpers.textbox (color.blue, "Ubuntu Nerd Font bold 17", "")
local forward =
  helpers.textbox (color.purple, "Ubuntu Nerd Font bold 17", "")
local backward =
  helpers.textbox (color.purple, "Ubuntu Nerd Font bold 17", "")
...
local function set_play_button ()
  if is_playing then
    play_pause.markup =
      helpers.mtext (color.blue, "Ubuntu Nerd Font bold 17", "")
  else
    play_pause.markup =
      helpers.mtext (color.blue, "Ubuntu Nerd Font bold 17", "")
  end
...
playerctl:connect_signal (
  ...
  function (_, title, artist, album_path, album, new, player_name)
    ...
    title_widget:set_markup_silently (
      helpers.mtext (color.lightblue, user.font .. " bold 14", title)
    )
    artist_widget:set_markup_silently (
      helpers.mtext (color.mid_light, user.font .. " 13", artist)
    )
  end
)
