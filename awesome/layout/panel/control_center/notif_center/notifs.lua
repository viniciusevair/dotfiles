		...
		{
			{
				...
				Separator,
				{
					...
					markup = '<span color="' ..
							color.lightblue .. '" font="IosevkaTermNF Bold 20">' .. 'No Notification Yet\n\n' .. '</span>',
					align = "center",
					valign = "center",
		...
		{
			{

				{
					{
						helpers.margin(
							helpers.textbox(color.fg_normal, "IosevkaTermNF bold 13", Notifications.title),
							20, 0, 0, 5),
						helpers.margin(
							helpers.textbox(color.fg_normal, "IosevkaTermNF 13", Notifications.message),
							20, 0, 0, 5),
						layout = wibox.layout.fixed.vertical,
					},
					widget = wibox.container.place,
