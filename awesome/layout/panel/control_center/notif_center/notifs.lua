    ...
    {
      {
        ...
        Separator,
        {
          ...
          markup = '<span color="' ..
          color.lightblue .. '" font=user.font .. " Bold 20">' .. 'No Notification Yet\n\n' .. '</span>',
          align = "center",
          valign = "center",
    ...
    {
      {

        {
          {
            helpers.margin(
            helpers.textbox(color.fg_normal, user.font .. " bold 13", Notifications.title),
            20, 0, 0, 5),
            helpers.margin(
            helpers.textbox(color.fg_normal, user.font .. " 13", Notifications.message),
            20, 0, 0, 5),
            layout = wibox.layout.fixed.vertical,
          },
          widget = wibox.container.place,
