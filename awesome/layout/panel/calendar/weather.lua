...
--Base_widgets------------
--------------------------
local city_text      = helpers.textbox(color.lightblue, "IosevkaTermNF bold 12", " Earth (probably)")
local country_text   = helpers.textbox(color.fg_normal, "IosevkaTermNF bold 12", ",SS")
local weather_txt    = helpers.textbox(color.lightblue, "IosevkaTermNF bold 12", "Loading...")
local temp_txt       = helpers.textbox(color.fg_normal, "IosevkaTermNF bold 30", " " .. '°C')
...
local NA             = helpers.textbox(color.fg_normal, "IosevkaTermNF 14", "N/A")
