...
--
----Title
--local title_widget = helpers.textbox(color.lightblue, "Ubuntu Nerd Font bold 15", "Nothing playing")
--title_widget.forced_width = dpi(250)
--title_widget.forced_height = dpi(35)
--title_widget.halign = 'center'
--
----Artist
--local artist_widget = helpers.textbox(color.mid_light, "Ubuntu Nerd Font 13", "Unknown artist")
...
--		title_widget:set_markup_silently(helpers.mtext(color.lightblue, "Ubuntu Nerd Font bold 14", title))
--		artist_widget:set_markup_silently(helpers.mtext(color.mid_light, "Ubuntu Nerd Font 13", artist))
--	end)
--
-------------------------------
----Position Slider------------
...
-- Return the mplayer widget instead of the popup directly
