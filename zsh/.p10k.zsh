# Generated by Powerlevel10k configuration wizard on 2023-03-01 at 15:10 -03.
...
# dotted, no frame, lightest-ornaments, compact, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=179
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=228
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=186
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%Hh%M}'
  ...
  function prompt_bebop() {
    p10k segment -f 186 -t $'%{\x1b[3m%}\u2728 you\'re gonna carry that weight \u2728%{\x1b[0m%}'
  }

  function prompt_cowboy() {
    p10k segment -f 242 -t $'%{\x1b[3m%}%BSEE YOU SPACE COWBOY%b%{\x1b[0m%}'
  }
